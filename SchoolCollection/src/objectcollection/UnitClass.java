...
public class UnitClass implements Comparable<UnitClass> {
	private Unit unit;
	...
	public int compareTo(UnitClass o) {
		String thisUnit =this.listClassStudent.toString();
		String oUnit= o.listClassStudent.toString();
		return thisUnit.compareTo(oUnit);
	}
